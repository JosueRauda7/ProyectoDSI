            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 additional-shop-info">
                    <ul class="list-unstyled list-inline">
                        <li><i class="fa fa-phone"></i><span>+503 0000-0000</span></li>
                        <!-- BEGIN CURRENCIES -->
                        ...
                        <li class="langs-block">
                            <a href="javascript:void(0);" class="current">Español </a>
                ...
                <div class="col-md-6 col-sm-6 additional-nav">
                    <ul class="list-unstyled list-inline pull-right">
                        ...
                        <li><a href="shop-checkout.html">Revisar</a></li>
      ...
      <div class="container">
        ...
        <div class="top-cart-block">
          <div class="top-cart-info">
            <a href="javascript:void(0);" class="top-cart-info-count">3 artículos</a>
        ...
        <div class="header-navigation">
          <ul>
                  ...
                  <div class="header-navigation-content">
                    <div class="row">
                      <div class="col-md-4 header-navigation-col">
                        <h4>Tipos de Muebles</h4>
                        <ul>
                          <li><a href="shop-product-list.html">Gaveteros</a></li>
                          <li><a href="shop-product-list.html">Joyeros</a></li>
                          <li><a href="shop-product-list.html">Juegos de Sala</a></li>
                          <li><a href="shop-product-list.html">Juegos de Comedor</a></li>
                          <li><a href="shop-product-list.html">Camas</a></li>
                        </ul>
                      </div>
                      <div class="col-md-4 header-navigation-col">
                        
                        <ul>
                          <li><a href="shop-product-list.html">Módulos</a></li>
                          <li><a href="shop-product-list.html">Closets</a></li>
                          <li><a href="shop-product-list.html">Sillones Reclinables</a></li>
                          <li><a href="shop-product-list.html">Camarotes</a></li>
                          <li><a href="shop-product-list.html">Libreras</a></li>
                          <li><a href="shop-product-list.html">Tocadores</a></li>
                        </ul>
                      </div>
                      <div class="col-md-4 header-navigation-col">
                        <ul>
                          <li><a href="shop-product-list.html">Mesas</a></li>
                          <li><a href="shop-product-list.html">Chineros</a></li>
                          <li><a href="shop-product-list.html">Muebles Varios</a></li>
                        </ul>
                      </div>
            ...
            <li><a href="shop-item.html">Electrodomésticos</a></li>
    ...
    <div class="main">
      <div class="container">
        ...
        <div style="float:right;" class="row product-list">
          <center><h1 style="text-indent: center;">Tendencias</h1></center>
              <!-- PRODUCT ITEM START -->
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  <div class="pi-img-wrapper">
